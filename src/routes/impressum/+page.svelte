...
<section>
  <div class="impressum">
    ...
    <br />
    <h2>Kontakt:</h2>
    <p>Email: info(at)heuwes-ahlers.de</p>
    <p>Fon: 0 52 31 – 30 12 01 0</p>
    <br />
    <br />
    <h2>Gestaltung | Layout | Programmierung:</h2>
    <p>Siegfried Albrecht</p>
    <br />
    <br />
    ...
    <p>
      ...
      bleiben hiervon unberührt. Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntnis einer konkreten Rechtsverletzung möglich. Bei
